...
URLS = ["http://storage.mds.yandex.net/get-devtools-opensource/250854/d890e25910eecce02b0c11acd30a324f"]
MD5 = "d890e25910eecce02b0c11acd30a324f"
...
def _mine_arc_root():
    ...
    if os.path.exists(os.path.join(src_root, '.arcadia.root')):
        return src_root
